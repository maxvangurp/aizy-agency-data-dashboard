...
export const SAMPLE_CLIENTS = [
  {
    ...
    primaryOwnerId: 'u-erik',
    supportingOwnerIds: ['u-benito'],
    maandbudget: 22000,
    ...
    doelen: [
      { kpi: 'omzet', periode: 'maand', target: 140000 },
      { kpi: 'roas', periode: 'maand', target: 7.5 },
      { kpi: 'aankopen', periode: 'maand', target: 400 },
      { kpi: 'maandbudget', periode: 'maand', target: 22000 },
    ],
  },
  {
    id: 'draadloos',
    ...
    valuta: 'EUR',
    tijdzone: 'Europe/Amsterdam',
    primaryOwnerId: 'u-jens',
    supportingOwnerIds: ['u-erik'],
    maandbudget: 12000,
    ...
    doelen: [
      { kpi: 'omzet', periode: 'maand', target: 68000 },
      { kpi: 'roas', periode: 'maand', target: 6.5 },
      { kpi: 'aankopen', periode: 'maand', target: 750 },
      { kpi: 'maandbudget', periode: 'maand', target: 12000 },
    ],
  },
  {
    id: 'kaapnoord',
    ...
    doelen: [
      { kpi: 'omzet', periode: 'maand', target: 200000 },
      { kpi: 'roas', periode: 'maand', target: 8.5 },
      { kpi: 'aankopen', periode: 'maand', target: 1200 },
      { kpi: 'maandbudget', periode: 'maand', target: 28000 },
    ],
  },
  {
    id: 'vitaalpunt',
  ...
  },
  {
    ...
    doelen: [
      { kpi: 'maandbudget', periode: 'maand', target: 18000 },
    ],
  },
];
