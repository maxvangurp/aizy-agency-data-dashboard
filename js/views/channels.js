...
export const KANAAL_TABS = {
  ...
  google_ads: [
    ...
    { key: 'zoektermen', label: 'Zoektermen', bron: 'zoektermen' },
    { key: 'advertenties', label: 'Advertenties', bron: 'advertenties' },
  ...
  meta_ads: [
    ...
    { key: 'campagnes', label: 'Campagnes', bron: 'campagnes' },
    { key: 'advertentiesets', label: 'Advertentiesets', bron: 'advertentiesets' },
    { key: 'advertenties', label: 'Advertenties', bron: 'advertenties' },
    { key: 'creatives', label: 'Creatives', bron: 'geen' },
    { key: 'doelgroepen', label: 'Doelgroepen', bron: 'doelgroepen' },
    { key: 'conversies', label: 'Conversies', bron: 'conversies' },
    { key: 'budget', label: 'Budget', bron: 'budget' },
  ],
  microsoft_ads: [
